...
int main() {
    ...
    printf("Enter Kanishka's private key: ");
    scanf("%lld", &privateA);
    ...
    printf("Kanishka's public key: (%lld, %lld)\n", publicA.x, publicA.y);
    ...
    printf("Shared secret computed by Kanishka: (%lld, %lld)\n", sharedSecretA.x, sharedSecretA.y);
...
## Output:
<img width="1629" height="896" alt="image" src="https://github.com/user-attachments/assets/c31b6a37-745a-4c3f-93e3-1a5fae2615d8" />
